...
// why does doing this on windows using gcc fix a free() crash in rx_panadapter when "zooming"?
// is this a compiler quirk? clearly thetis doesnt have this issue.
// seems to be just win32 and gcc (mingw/msys/etc)
